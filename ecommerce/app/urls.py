...
urlpatterns = [
    ...
    path("password-change/", auth_view.PasswordChangeView.as_view(template_name='app/password_change.html', form_class=MyPasswordChangeForm, success_url="/password_change_done"), name='password_change'),
